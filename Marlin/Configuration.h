...
#define STRING_CONFIG_H_AUTHOR "(Frank Tam, Ender 5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Custom 5 Plus"
...
//#define NOZZLE_TO_PROBE_OFFSET { -54, -23, -3 }
#define NOZZLE_TO_PROBE_OFFSET { -54, -23, -3 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 50
//#define PROBING_MARGIN 65
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 28
